...
//  Assumption: A tree contains at most one item wih a
//  given search ket ar any time.
...
public class BinarySearchTree<T extends KeyedItem<KT>
  ...
  //*************************************
  //precondition: binary search tree.
  //postcondition: display the binary search tree.
  //*****************************************
